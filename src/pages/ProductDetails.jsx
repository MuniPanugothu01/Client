...
const ProductDetails = () => {
  ...
  // get product id
  const { id } = useParams();
  // create the state varibale name
  const [relatedProducts, setRelatedProducts] = useState([]);

  const [thumbnail, setThumbnail] = useState(null);
  // find the individual product using products array
  ...
  // another useEffect() for individual product
  useEffect(() => {
